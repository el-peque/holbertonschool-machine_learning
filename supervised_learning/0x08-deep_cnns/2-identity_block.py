...
def identity_block(A_prev, filters):
    ...
    batch_norm_1 = K.layers.BatchNormalization(axis=3)(conv_1)
    ...
    batch_norm_2 = K.layers.BatchNormalization(axis=3)(conv_2)
    ...
    batch_norm_3 = K.layers.BatchNormalization(axis=3)(conv_3)
